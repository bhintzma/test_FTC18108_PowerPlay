 ...
 * phone or https://192.168.43.1:8080/dash if you are usinxg the Control Hub. Once you've successfully
...
public class DriveVelocityPIDTuner extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        ppb.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, MOTOR_VELO_PID);
        ...
        while (!isStopRequested()) {
            ...
            switch (mode) {
                case TUNING_MODE:
                    ...
                    List<Double> velocities = ppb.getWheelVelocities();
                ...
                case DRIVER_MODE:
                    if (gamepad1.b) {
                        ppb.setMode(DcMotorEx.RunMode.RUN_USING_ENCODER);
            ...
            if (lastKp != MOTOR_VELO_PID.p || lastKd != MOTOR_VELO_PID.d
                ...
                ppb.setPIDFCoefficients(DcMotorEx.RunMode.RUN_USING_ENCODER, MOTOR_VELO_PID);
