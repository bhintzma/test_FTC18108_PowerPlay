...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    private Encoder vertical1, vertical2, horizontal;
    ...
    public List<Double> getWheelPositions() {
        return Arrays.asList(
                encoderTicksToInches(vertical1.getCurrentPosition()),
                encoderTicksToInches(vertical2.getCurrentPosition()),
                encoderTicksToInches(horizontal.getCurrentPosition())
        );
    }
    ...
    public List<Double> getWheelVelocities() {
        ...
        return Arrays.asList(
                encoderTicksToInches(vertical1.getRawVelocity()),
                encoderTicksToInches(vertical2.getRawVelocity()),
                encoderTicksToInches(horizontal.getRawVelocity())
        );
    }
}
